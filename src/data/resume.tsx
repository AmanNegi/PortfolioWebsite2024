  ...
  work: [
    {
      ...
      location: 'Bangalore',
      title: "SDE Intern",
      logoUrl: '/simbian.jpeg',
      start: 'Sept 2025',
      end: 'Present',
      description: 'Designed and delivered end-to-end workflows across multiple agents, including the GRC Agent and Pentest Agent, integrating backend and frontend systems for seamless functionality, while leading a comprehensive UI/UX overhaul and migrating the product from Django Templates to React, resulting in improved performance, scalability, and a more intuitive user experience.',
    },
    {
      company: "CRED",
      href: "https://cred.club",
      badges: [],
      location: "Indirangar, Bangalore",
      title: "SDE Intern",
      logoUrl: "/cred.jpeg",
      start: 'Feb 2025',
      end: 'Aug 2025',
      description: 'Joined the Growth & Rewards team and automated the ad creation process for brands, reducing developer dependency and cutting overall turnaround time by 90%, while also launching data-driven campaigns that resulted in a measurable increase in returning user activity and session frequency.',
    },
    {
      company: "BitScale.ai",
      ...
      logoUrl: '/bitscale.jpeg',
      start: 'Nov 2024',
      end: 'Feb 2025',
      description: 'Assisted in enhancing and maintaining an existing codebase by refactoring and restructuring the project, while also implementing new features, including an LLM-powered capability that enables users to generate formulae automatically.',
    },
    {
